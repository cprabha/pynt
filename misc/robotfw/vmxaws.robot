*** Settings ***
Library	../../pynt/VmxAws.py	vpc=smk_aws_auto_svl	cidr=192.168.128.0/17	subnet_mask=24	subnet_cnt=4

*** Variables ***
${vpc_name}   smk_aws_auto_svl
${mgmt_vpc_name}   smk_jumphost_vpc
${key_file}	~/.ssh/smk_vmx_aws_svl.pem
#${ami_vmx}	ami-0d551f6d# 15.1F6-S1.4-9
${ami_vmx}     ami-4a9dd72a
${ami_lnx}	ami-06116566
${inst_type_vmx}   m4.4xlarge
...
Launch Endpoint EC2 Ubuntu Hosts
	...
	${smk-lnx01}	Create Dictionary	iname=smk-lnx01	ips=@{ifset1}
	${smk-lnx02}	Create Dictionary	iname=smk-lnx02	ips=@{ifset2}
	@{params}	Create List	${smk-lnx01}	${smk-lnx02}
...
Setup Linux hosts
	...
	[Tags]	Performance
	@{inst_names}	Create List	smk-lnx01	smk-lnx02
	#: For	${inst_name}	in	@{inst_names}
...
#	[Tags]	Performance
#	@{smk-lnx01}	Create List	smk-lnx01	192.168.1.5	192.168.1.4
#	@{smk-lnx02}	Create List	smk-lnx02	192.168.2.6	192.168.2.4
#	Throughput with IPerf3	smk-lnx01	smk-lnx02
